...
case class WithUserAccess(targetUserId: Long, level: AccessLevel)(implicit accessRules: AccessRules)
...
case class WithQuestionnaireAccess(questionnaireId: Long, level: AccessLevel)(implicit accessRules: AccessRules)
    extends Authorization[User, BearerTokenAuthenticator] {
...
case class WithQuestionAccess(questionId: Long, level: AccessLevel)(implicit accessRules: AccessRules)
    extends Authorization[User, BearerTokenAuthenticator] {
...
case class WithAnswerAccess(answerId: Long, level: AccessLevel)(implicit accessRules: AccessRules)
    extends Authorization[User, BearerTokenAuthenticator] {
